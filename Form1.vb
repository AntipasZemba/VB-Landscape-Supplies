Public Class Form1
    ...
    Private Sub btnAddProduct_Click(sender As Object, e As EventArgs) Handles btnAddProduct.Click
        Dim shtBags As Short
        Dim strProduct As String
        Dim dblProductTotal As Double

        Dim blnValidated As Boolean = True

        GetandValidate_Input(shtBags, strProduct, blnValidated)

        If blnValidated Then
            dblProductTotal = Calculate_Product_SubTotal(shtBags, strProduct)
            Accumulate_Order_Total(dblProductTotal)
            Display_Product(strProduct, shtBags, dblProductTotal)
        End If
    End Sub

    Private Sub GetandValidate_Input(ByRef shtBags As Short, ByRef strProduct As String, ByRef blnValidated As Boolean)
        ...
        If blnValidated Then
            ...
            If blnValidated Then
                ...
                If blnValidated Then
                    ValidateBags(shtBags, blnValidated)
                End If
            End If
        End If
    End Sub
    ...
    Private Sub ValidateBags(ByRef shtBags As Short, ByRef blnValidated As Boolean)
        If Short.TryParse(txtBags.Text, shtBags) Then
            If (shtBags > 0) And (shtBags < 51) Then
            Else
    ...
    Private Function Calculate_Product_SubTotal(ByVal shtBags As Short, ByVal strProduct As String) As Double
    ...
    Private Sub Display_Product(ByVal strProduct As String, ByVal shtBags As String, ByVal dblProductTotal As Double)
        ...
        lstOrderDisplay.Items.Add(strProduct & vbTab & shtBags & vbTab & dblProductTotal.ToString("c"))
